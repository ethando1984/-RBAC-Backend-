...
public class PermissionServiceImpl implements PermissionService {
    ...
    public List<Permission> getAll() { return mapper.findAll(); }
    public Permission getById(UUID id) { return mapper.findById(id); }
    public void create(Permission entity) { mapper.insert(entity); }
    public void update(Permission entity) { mapper.update(entity); }
